...
{	private GLCanvas myCanvas;
	...
	private String HUD1string, HUD2string, HUD3string, HUD4string; // New Add
	private float[] HUD1color, HUD2color, HUD3color, HUD4color; // New Add
	private int HUD1font = GLUT.BITMAP_TIMES_ROMAN_24;
	private int HUD2font = GLUT.BITMAP_TIMES_ROMAN_24;
	private int HUD3font = GLUT.BITMAP_TIMES_ROMAN_24; // New Add
	private int HUD4font = GLUT.BITMAP_TIMES_ROMAN_24; // New Add
	private int HUD1x, HUD1y, HUD2x, HUD2y, HUD3x, HUD3y, HUD4x, HUD4y; // New Add
	private int currCanvasWidth, currCanvasHeight, widthOffset, heightOffset;
	...
	public void setWindowDimensions() {
		widthOffset = 0;
		heightOffset = 0;
		currCanvasWidth = myCanvas.getWidth();
		currCanvasHeight = myCanvas.getHeight();
	}

	public boolean isCanvasTabletMode() {
		return myCanvas.getWidth() < 890;
	}
	
	public void adjustRelativePosition() {
		System.out.println("Canvas Width: " + myCanvas.getWidth());
	}
